...
### Teamets implementasjon av Two-phase commit protocol
...
Under stemmeprosessen i fase 1 får klienten et valg om å stemme ja/nei om de vil bli med på transaksjonen som er satt i gang. I denne prosessen har gruppen valgt å implementere en timer mens koordinator venter på svar. Dette er for å løse problemet med en inaktiv klient, eller en klient som av en eller annen grunn ikke får svart. Etter at tiden går ut blir klienten kastet ut, og transaksjonen den var en del av rulles tilbake. Videre kan gjenværende klienter fortsette ved å opprette en ny transaksjon.

### Fremtidig arbeid

Selv om teamet er fornøyde med produktet er det noen ting som kunne blitt gjort bedre med mer tid. I tillegg er det noe funksjonalitet som gruppen ønsket å implementere, men ikke hadde tid til. Under vil det bli listet mangler gruppen føler applikasjonen har og mulige forbedringer.
...
#### Mulige forbedringer og tillegg
